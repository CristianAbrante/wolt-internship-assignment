...
export const popularityMock1: Restaurant[] = [
  {
...
export const popularitySortedMock1: Restaurant["popularity"][] = [
  0.8212304387029502,
  0.40907452479616846,
  0.3919633748546864,
  0.30706741877410304,
...
export const popularityMock2: Restaurant[] = [
  {
    blurhash: "UKFGw4^KM}$$x@X8N1kB10R+xEWWR8Rlt4o0",
    launch_date: "2020-02-23",
    location: [-16.571345, 28.379189],
...
export const popularitySortedMock2: Restaurant["popularity"][] = [
  0.0,
  0.0,
  0.0,
  0.0,
...
export const popularityMock3: Restaurant[] = [
  {
    blurhash: "UKFGw4^KM}$$x@X8N1kB10R+xEWWR8Rlt4o0",
    launch_date: "2020-02-23",
    location: [-16.571345, 28.379189],
...
export const popularitySortedMock3: Restaurant["popularity"][] = [
  0.741748846018373,
  0.6251161053931533,
  0.32967241195011165,
  0.18821176187284486,
